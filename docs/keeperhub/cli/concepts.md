<!-- source: https://docs.keeperhub.com/cli/concepts -->

# Concepts

# Concepts

## What is KeeperHub[](https://docs.keeperhub.com/cli/concepts#what-is-keeperhub)
...
## CLI vs Web UI[](https://docs.keeperhub.com/cli/concepts#cli-vs-web-ui)
...
## Authentication Model[](https://docs.keeperhub.com/cli/concepts#authentication-model)
...
## Output Formats[](https://docs.keeperhub.com/cli/concepts#output-formats)
...
## Configuration[](https://docs.keeperhub.com/cli/concepts#configuration)
...
## MCP Server Mode[](https://docs.keeperhub.com/cli/concepts#mcp-server-mode)
...
The server communicates over stdin/stdout. When integrated with Claude Desktop, the host application manages the process lifecycle. See [Quickstart](https://docs.keeperhub.com/cli/quickstart) for setup instructions.
