<!-- source: https://docs.keeperhub.com/notifications/templates -->
...
## Template Types[](https://docs.keeperhub.com/notifications/templates#template-types)

Notification templates depend on **Keeper Type** and **Trigger Type**:

### Keeper Types[](https://docs.keeperhub.com/notifications/templates#keeper-types)

-   **Contract**: Smart contract interactions
-   **Wallet**: Wallet monitoring and operations
-   **Multisig**: Multisig wallet monitoring

### Trigger Types[](https://docs.keeperhub.com/notifications/templates#trigger-types)
...
### Contract Keeper Templates[](https://docs.keeperhub.com/notifications/templates#contract-keeper-templates)

For Contract keepers, templates further depend on **Function Type**:

#### Read Functions[](https://docs.keeperhub.com/notifications/templates#read-functions)

-   **Contract Read Template**: For read-only function calls

#### Write Functions[](https://docs.keeperhub.com/notifications/templates#write-functions)
...
### Event Trigger Templates[](https://docs.keeperhub.com/notifications/templates#event-trigger-templates)

-   **Event Template**: For Event detection (used across all keeper types when Event trigger is selected)

### Wallet & Multisig Keeper Templates[](https://docs.keeperhub.com/notifications/templates#wallet--multisig-keeper-templates)
...
## Contract Keeper with Read Function[](https://docs.keeperhub.com/notifications/templates#contract-keeper-with-read-function)
...
## Contract Keeper with Write Function (Success)[](https://docs.keeperhub.com/notifications/templates#contract-keeper-with-write-function-success)
...
## Contract Keeper with Write Function (Failure)[](https://docs.keeperhub.com/notifications/templates#contract-keeper-with-write-function-failure)
...
## Contract Keeper with Event Trigger[](https://docs.keeperhub.com/notifications/templates#contract-keeper-with-event-trigger)
...
## Wallet Keeper[](https://docs.keeperhub.com/notifications/templates#wallet-keeper)
...
## Multisig Keeper[](https://docs.keeperhub.com/notifications/templates#multisig-keeper)
