<!-- source: https://docs.keeperhub.com/plugins/aerodrome -->
...
## Actions[](https://docs.keeperhub.com/plugins/aerodrome#actions)
...
## Events[](https://docs.keeperhub.com/plugins/aerodrome#events)
...
## Get Pool Reserves[](https://docs.keeperhub.com/plugins/aerodrome#get-pool-reserves)
...
## Get Pool Address[](https://docs.keeperhub.com/plugins/aerodrome#get-pool-address)
...
## Get Expected Output[](https://docs.keeperhub.com/plugins/aerodrome#get-expected-output)
...
## Get Total Pool Count[](https://docs.keeperhub.com/plugins/aerodrome#get-total-pool-count)
...
## Get Total Voting Weight[](https://docs.keeperhub.com/plugins/aerodrome#get-total-voting-weight)
...
## Check Gauge Status[](https://docs.keeperhub.com/plugins/aerodrome#check-gauge-status)
...
## Get Gauge for Pool[](https://docs.keeperhub.com/plugins/aerodrome#get-gauge-for-pool)
...
## Get veNFT Voting Power[](https://docs.keeperhub.com/plugins/aerodrome#get-venft-voting-power)
...
## Get Lock Details[](https://docs.keeperhub.com/plugins/aerodrome#get-lock-details)
...
## Get AERO Balance[](https://docs.keeperhub.com/plugins/aerodrome#get-aero-balance)
...
## Swap Exact Tokens[](https://docs.keeperhub.com/plugins/aerodrome#swap-exact-tokens)
...
## Add Liquidity[](https://docs.keeperhub.com/plugins/aerodrome#add-liquidity)
...
## Remove Liquidity[](https://docs.keeperhub.com/plugins/aerodrome#remove-liquidity)
...
## Vote on Gauges[](https://docs.keeperhub.com/plugins/aerodrome#vote-on-gauges)
...
## Reset Votes[](https://docs.keeperhub.com/plugins/aerodrome#reset-votes)
...
## Create veAERO Lock[](https://docs.keeperhub.com/plugins/aerodrome#create-veaero-lock)
...
## Increase Lock Amount[](https://docs.keeperhub.com/plugins/aerodrome#increase-lock-amount)
...
## Increase Lock Duration[](https://docs.keeperhub.com/plugins/aerodrome#increase-lock-duration)
...
## Withdraw Expired Lock[](https://docs.keeperhub.com/plugins/aerodrome#withdraw-expired-lock)
...
## Claim Gauge Rewards[](https://docs.keeperhub.com/plugins/aerodrome#claim-gauge-rewards)
...
## Approve AERO[](https://docs.keeperhub.com/plugins/aerodrome#approve-aero)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/aerodrome#example-workflows)

### Pool Reserve Monitor[](https://docs.keeperhub.com/plugins/aerodrome#pool-reserve-monitor)
...
### Swap Quote Tracker[](https://docs.keeperhub.com/plugins/aerodrome#swap-quote-tracker)
...
### veNFT Voting Power Monitor[](https://docs.keeperhub.com/plugins/aerodrome#venft-voting-power-monitor)
...
### veNFT Lock Expiry Watchdog[](https://docs.keeperhub.com/plugins/aerodrome#venft-lock-expiry-watchdog)
...
### Weekly Vote Reset and Re-Vote[](https://docs.keeperhub.com/plugins/aerodrome#weekly-vote-reset-and-re-vote)
...
### Reward Harvesting and Compounding[](https://docs.keeperhub.com/plugins/aerodrome#reward-harvesting-and-compounding)
...
### LP Position Manager[](https://docs.keeperhub.com/plugins/aerodrome#lp-position-manager)
...
### AERO Treasury Dashboard[](https://docs.keeperhub.com/plugins/aerodrome#aero-treasury-dashboard)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/aerodrome#supported-chains)
