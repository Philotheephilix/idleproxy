<!-- source: https://docs.keeperhub.com/plugins/compound -->
...
## Comet Market Addresses[](https://docs.keeperhub.com/plugins/compound#comet-market-addresses)
...
## Actions[](https://docs.keeperhub.com/plugins/compound#actions)
...
## Supply Asset[](https://docs.keeperhub.com/plugins/compound#supply-asset)
...
## Withdraw Asset[](https://docs.keeperhub.com/plugins/compound#withdraw-asset)
...
## Get Base Balance[](https://docs.keeperhub.com/plugins/compound#get-base-balance)
...
## Get Collateral Balance[](https://docs.keeperhub.com/plugins/compound#get-collateral-balance)
...
## Get Borrow Balance[](https://docs.keeperhub.com/plugins/compound#get-borrow-balance)
...
## Get Utilization[](https://docs.keeperhub.com/plugins/compound#get-utilization)
...
## Get Supply Rate[](https://docs.keeperhub.com/plugins/compound#get-supply-rate)
...
## Get Borrow Rate[](https://docs.keeperhub.com/plugins/compound#get-borrow-rate)
...
## Get Total Supply[](https://docs.keeperhub.com/plugins/compound#get-total-supply)
...
## Get Total Borrow[](https://docs.keeperhub.com/plugins/compound#get-total-borrow)
...
## Is Liquidatable[](https://docs.keeperhub.com/plugins/compound#is-liquidatable)
...
## Get Number of Assets[](https://docs.keeperhub.com/plugins/compound#get-number-of-assets)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/compound#example-workflows)

### Supply Balance Monitor[](https://docs.keeperhub.com/plugins/compound#supply-balance-monitor)
...
### Borrow Position Monitor[](https://docs.keeperhub.com/plugins/compound#borrow-position-monitor)
...
### Auto-Supply on Deposit[](https://docs.keeperhub.com/plugins/compound#auto-supply-on-deposit)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/compound#supported-chains)
