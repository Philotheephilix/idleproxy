<!-- source: https://docs.keeperhub.com/plugins/curve -->
...
## Actions[](https://docs.keeperhub.com/plugins/curve#actions)
...
## Get Expected Output[](https://docs.keeperhub.com/plugins/curve#get-expected-output)
...
## Get Virtual Price[](https://docs.keeperhub.com/plugins/curve#get-virtual-price)
...
## Get Coin Address[](https://docs.keeperhub.com/plugins/curve#get-coin-address)
...
## Get Pool Balance[](https://docs.keeperhub.com/plugins/curve#get-pool-balance)
...
## Exchange Tokens[](https://docs.keeperhub.com/plugins/curve#exchange-tokens)
...
| j | int128 | Output Coin Index |
| dx | uint256 | Input Amount (wei) |
| min\_dy | uint256 | Minimum Output (wei) |
...
## Get CRV Balance[](https://docs.keeperhub.com/plugins/curve#get-crv-balance)
...
## Approve CRV[](https://docs.keeperhub.com/plugins/curve#approve-crv)
...
## Transfer CRV[](https://docs.keeperhub.com/plugins/curve#transfer-crv)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/curve#example-workflows)

### Pool Imbalance Monitor[](https://docs.keeperhub.com/plugins/curve#pool-imbalance-monitor)
...
### Pre-Swap Quote and Execute[](https://docs.keeperhub.com/plugins/curve#pre-swap-quote-and-execute)
...
### CRV Accumulation Alert[](https://docs.keeperhub.com/plugins/curve#crv-accumulation-alert)
...
### Virtual Price Deviation Alert[](https://docs.keeperhub.com/plugins/curve#virtual-price-deviation-alert)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/curve#supported-chains)
