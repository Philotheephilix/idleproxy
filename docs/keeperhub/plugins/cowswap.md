<!-- source: https://docs.keeperhub.com/plugins/cowswap -->
...
## Actions[](https://docs.keeperhub.com/plugins/cowswap#actions)
...
## Get Domain Separator[](https://docs.keeperhub.com/plugins/cowswap#get-domain-separator)
...
## Get Vault Relayer[](https://docs.keeperhub.com/plugins/cowswap#get-vault-relayer)
...
## Get Order Fill Amount[](https://docs.keeperhub.com/plugins/cowswap#get-order-fill-amount)
...
## Get Pre-Signature Status[](https://docs.keeperhub.com/plugins/cowswap#get-pre-signature-status)
...
## Set Pre-Signature[](https://docs.keeperhub.com/plugins/cowswap#set-pre-signature)
...
## Invalidate Order[](https://docs.keeperhub.com/plugins/cowswap#invalidate-order)
...
## Check Conditional Order[](https://docs.keeperhub.com/plugins/cowswap#check-conditional-order)
...
## Get Cabinet Value[](https://docs.keeperhub.com/plugins/cowswap#get-cabinet-value)
...
## Remove Conditional Order[](https://docs.keeperhub.com/plugins/cowswap#remove-conditional-order)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/cowswap#example-workflows)

### Safe Multisig Order Execution[](https://docs.keeperhub.com/plugins/cowswap#safe-multisig-order-execution)
...
### Order Monitoring and Cancellation[](https://docs.keeperhub.com/plugins/cowswap#order-monitoring-and-cancellation)
...
### Conditional Order Lifecycle[](https://docs.keeperhub.com/plugins/cowswap#conditional-order-lifecycle)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/cowswap#supported-chains)
