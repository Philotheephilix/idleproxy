<!-- source: https://docs.keeperhub.com/plugins/sendgrid -->
...
## Actions[](https://docs.keeperhub.com/plugins/sendgrid#actions)

| Action | Description |
| --- | --- |
| Send Email | Send an email to one or more recipients |

## Setup[](https://docs.keeperhub.com/plugins/sendgrid#setup)
...
## Send Email[](https://docs.keeperhub.com/plugins/sendgrid#send-email)
