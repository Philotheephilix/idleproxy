<!-- source: https://docs.keeperhub.com/plugins/pendle -->
...
## Actions[](https://docs.keeperhub.com/plugins/pendle#actions)
...
## Get vePENDLE Balance[](https://docs.keeperhub.com/plugins/pendle#get-vependle-balance)
...
## Get vePENDLE Total Supply[](https://docs.keeperhub.com/plugins/pendle#get-vependle-total-supply)
...
## Get vePENDLE Lock Position[](https://docs.keeperhub.com/plugins/pendle#get-vependle-lock-position)
...
## Get Market Expiry[](https://docs.keeperhub.com/plugins/pendle#get-market-expiry)
...
## Is Market Expired[](https://docs.keeperhub.com/plugins/pendle#is-market-expired)
...
## Get LP Balance[](https://docs.keeperhub.com/plugins/pendle#get-lp-balance)
...
## Get Active LP Balance[](https://docs.keeperhub.com/plugins/pendle#get-active-lp-balance)
...
## Get PT Balance[](https://docs.keeperhub.com/plugins/pendle#get-pt-balance)
...
## Is PT Expired[](https://docs.keeperhub.com/plugins/pendle#is-pt-expired)
...
## Get YT Balance[](https://docs.keeperhub.com/plugins/pendle#get-yt-balance)
...
## Get SY Balance[](https://docs.keeperhub.com/plugins/pendle#get-sy-balance)
...
## Get SY Exchange Rate[](https://docs.keeperhub.com/plugins/pendle#get-sy-exchange-rate)
...
## Mint PT and YT from SY[](https://docs.keeperhub.com/plugins/pendle#mint-pt-and-yt-from-sy)
...
## Redeem PT and YT to SY[](https://docs.keeperhub.com/plugins/pendle#redeem-pt-and-yt-to-sy)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/pendle#example-workflows)

### Monitor vePENDLE Voting Power[](https://docs.keeperhub.com/plugins/pendle#monitor-vependle-voting-power)
...
### Track Market Expiry and Alert[](https://docs.keeperhub.com/plugins/pendle#track-market-expiry-and-alert)
...
### Monitor LP Position Health[](https://docs.keeperhub.com/plugins/pendle#monitor-lp-position-health)
...
### Auto-Alert on SY Exchange Rate Changes[](https://docs.keeperhub.com/plugins/pendle#auto-alert-on-sy-exchange-rate-changes)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/pendle#supported-chains)
