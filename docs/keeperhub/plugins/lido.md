<!-- source: https://docs.keeperhub.com/plugins/lido -->
...
## Actions[](https://docs.keeperhub.com/plugins/lido#actions)
...
## Wrap stETH to wstETH[](https://docs.keeperhub.com/plugins/lido#wrap-steth-to-wsteth)
...
## Unwrap wstETH to stETH[](https://docs.keeperhub.com/plugins/lido#unwrap-wsteth-to-steth)
...
## Approve stETH Spending[](https://docs.keeperhub.com/plugins/lido#approve-steth-spending)
...
## Get stETH by wstETH[](https://docs.keeperhub.com/plugins/lido#get-steth-by-wsteth)
...
## Get wstETH by stETH[](https://docs.keeperhub.com/plugins/lido#get-wsteth-by-steth)
...
## stETH Per Token (Exchange Rate)[](https://docs.keeperhub.com/plugins/lido#steth-per-token-exchange-rate)
...
## wstETH Per stETH (Inverse Rate)[](https://docs.keeperhub.com/plugins/lido#wsteth-per-steth-inverse-rate)
...
## Get wstETH Balance[](https://docs.keeperhub.com/plugins/lido#get-wsteth-balance)
...
## Get wstETH Total Supply[](https://docs.keeperhub.com/plugins/lido#get-wsteth-total-supply)
...
## Get stETH Balance[](https://docs.keeperhub.com/plugins/lido#get-steth-balance)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/lido#example-workflows)

### wstETH Exchange Rate Monitor[](https://docs.keeperhub.com/plugins/lido#wsteth-exchange-rate-monitor)
...
### wstETH Position Value Tracker[](https://docs.keeperhub.com/plugins/lido#wsteth-position-value-tracker)
...
### stETH/wstETH Rate Alert[](https://docs.keeperhub.com/plugins/lido#stethwsteth-rate-alert)
...
### wstETH Total Supply Dashboard[](https://docs.keeperhub.com/plugins/lido#wsteth-total-supply-dashboard)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/lido#supported-chains)
