<!-- source: https://docs.keeperhub.com/plugins/telegram -->
...
## Actions[](https://docs.keeperhub.com/plugins/telegram#actions)

| Action | Description |
| --- | --- |
| Send Message | Send a text message to a Telegram chat |

## Setup[](https://docs.keeperhub.com/plugins/telegram#setup)
...
## Send Message[](https://docs.keeperhub.com/plugins/telegram#send-message)
