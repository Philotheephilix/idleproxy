<!-- source: https://docs.keeperhub.com/plugins/math -->
...
## Actions[](https://docs.keeperhub.com/plugins/math#actions)

| Action | Description |
| --- | --- |
| Aggregate | Reduce multiple values into one via sum, count, average, median, min, max, product |

## Aggregate[](https://docs.keeperhub.com/plugins/math#aggregate)
...
### Aggregation Operations[](https://docs.keeperhub.com/plugins/math#aggregation-operations)
...
### Post-Aggregation Operations[](https://docs.keeperhub.com/plugins/math#post-aggregation-operations)
...
### Input Modes[](https://docs.keeperhub.com/plugins/math#input-modes)
...
### Inputs[](https://docs.keeperhub.com/plugins/math#inputs)
...
### Outputs[](https://docs.keeperhub.com/plugins/math#outputs)
...
### BigInt Handling[](https://docs.keeperhub.com/plugins/math#bigint-handling)
...
### String-Encoded Numbers[](https://docs.keeperhub.com/plugins/math#string-encoded-numbers)
...
-   Integer strings: `"1000000000000000000"` -> BigInt if above MAX\_SAFE\_INTEGER
...
## Example Workflows[](https://docs.keeperhub.com/plugins/math#example-workflows)

### Sum Token Balances Across Liquidity Pools (Explicit Mode)[](https://docs.keeperhub.com/plugins/math#sum-token-balances-across-liquidity-pools-explicit-mode)
...
### Multi-Token Ratio with Unit Conversion (Chained Aggregates)[](https://docs.keeperhub.com/plugins/math#multi-token-ratio-with-unit-conversion-chained-aggregates)
...
### Daily Event Volume (Count + Sum with Array Mode)[](https://docs.keeperhub.com/plugins/math#daily-event-volume-count--sum-with-array-mode)
...
### Gas Budget Alert (Sum + Subtract Threshold)[](https://docs.keeperhub.com/plugins/math#gas-budget-alert-sum--subtract-threshold)
...
### Median Price from Multiple Oracles[](https://docs.keeperhub.com/plugins/math#median-price-from-multiple-oracles)
...
### Product for Compound Growth Factors[](https://docs.keeperhub.com/plugins/math#product-for-compound-growth-factors)
...
### Loop Results Aggregation (Array Mode)[](https://docs.keeperhub.com/plugins/math#loop-results-aggregation-array-mode)
...
### Absolute Delta Detection[](https://docs.keeperhub.com/plugins/math#absolute-delta-detection)
...
### Floor/Ceil for Integer Rounding[](https://docs.keeperhub.com/plugins/math#floorceil-for-integer-rounding)
