<!-- source: https://docs.keeperhub.com/plugins/spark -->
...
## Actions[](https://docs.keeperhub.com/plugins/spark#actions)
...
## Supply Asset[](https://docs.keeperhub.com/plugins/spark#supply-asset)
...
## Withdraw Asset[](https://docs.keeperhub.com/plugins/spark#withdraw-asset)
...
## Borrow Asset[](https://docs.keeperhub.com/plugins/spark#borrow-asset)
...
## Repay Debt[](https://docs.keeperhub.com/plugins/spark#repay-debt)
...
## Set Asset as Collateral[](https://docs.keeperhub.com/plugins/spark#set-asset-as-collateral)
...
## Deposit DAI to sDAI[](https://docs.keeperhub.com/plugins/spark#deposit-dai-to-sdai)
...
## Redeem sDAI for DAI[](https://docs.keeperhub.com/plugins/spark#redeem-sdai-for-dai)
...
## Get User Account Data[](https://docs.keeperhub.com/plugins/spark#get-user-account-data)
...
## Get User Reserve Data[](https://docs.keeperhub.com/plugins/spark#get-user-reserve-data)
...
## Get sDAI Balance[](https://docs.keeperhub.com/plugins/spark#get-sdai-balance)
...
## Get sDAI Total Assets[](https://docs.keeperhub.com/plugins/spark#get-sdai-total-assets)
...
## Convert sDAI to DAI Value[](https://docs.keeperhub.com/plugins/spark#convert-sdai-to-dai-value)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/spark#example-workflows)

### Health Factor Monitor with Discord Alert[](https://docs.keeperhub.com/plugins/spark#health-factor-monitor-with-discord-alert)
...
### Auto-Repay on Low Health Factor[](https://docs.keeperhub.com/plugins/spark#auto-repay-on-low-health-factor)
...
### sDAI Savings Monitor[](https://docs.keeperhub.com/plugins/spark#sdai-savings-monitor)
...
### sDAI TVL Tracker with Webhook[](https://docs.keeperhub.com/plugins/spark#sdai-tvl-tracker-with-webhook)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/spark#supported-chains)
