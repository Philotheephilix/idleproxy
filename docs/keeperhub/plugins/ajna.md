<!-- source: https://docs.keeperhub.com/plugins/ajna -->
...
## Actions[](https://docs.keeperhub.com/plugins/ajna#actions)
...
## Get Auction Status[](https://docs.keeperhub.com/plugins/ajna#get-auction-status)
...
| --- | --- | --- |
| ajnaPool\_ | address | Pool Address |
| borrower\_ | address | Borrower Address |

**Outputs:**

| Output | Type | Description |
| --- | --- | --- |
| kickTime\_ | uint256 | Kick Timestamp |
| collateral\_ | uint256 | Collateral (WAD), 18 decimals |
| debtToCover\_ | uint256 | Debt to Cover (WAD), 18 decimals |
| isCollateralized\_ | bool | Is Collateralized |
| price\_ | uint256 | Current Price (WAD), 18 decimals |
| neutralPrice\_ | uint256 | Neutral Price (WAD), 18 decimals |
| referencePrice\_ | uint256 | Reference Price (WAD), 18 decimals |
| debtToCollateral\_ | uint256 | Debt to Collateral (WAD), 18 decimals |
| bondFactor\_ | uint256 | Bond Factor (WAD), 18 decimals |
...
## Get HPB Index[](https://docs.keeperhub.com/plugins/ajna#get-hpb-index)
...
## Get Pool LUP[](https://docs.keeperhub.com/plugins/ajna#get-pool-lup)
...
## Get Pool HTP[](https://docs.keeperhub.com/plugins/ajna#get-pool-htp)
...
## Get Borrower Info[](https://docs.keeperhub.com/plugins/ajna#get-borrower-info)
...
## Price to Bucket Index[](https://docs.keeperhub.com/plugins/ajna#price-to-bucket-index)
...
## Bucket Index to Price[](https://docs.keeperhub.com/plugins/ajna#bucket-index-to-price)
...
## Get Deposit Index[](https://docs.keeperhub.com/plugins/ajna#get-deposit-index)
...
| --- | --- | --- |
| ajnaPool\_ | address | Pool Address |
| debt\_ | uint256 | Debt Amount (WAD) |
...
## Pool 1 Kicker Info[](https://docs.keeperhub.com/plugins/ajna#pool-1-kicker-info)
...
| Input | Type | Description |
| --- | --- | --- |
| kicker\_ | address | Kicker Address |
...
## Pool 1 Auction Info[](https://docs.keeperhub.com/plugins/ajna#pool-1-auction-info)
...
## Pool 1 Bucket Info[](https://docs.keeperhub.com/plugins/ajna#pool-1-bucket-info)
...
## Pool 1 Inflator Info[](https://docs.keeperhub.com/plugins/ajna#pool-1-inflator-info)
...
## Pool 1 Kick[](https://docs.keeperhub.com/plugins/ajna#pool-1-kick)
...
| --- | --- | --- |
| borrower\_ | address | Borrower Address |
| limitIndex\_ | uint256 | Limit Bucket Index |
...
## Pool 1 Bucket Take[](https://docs.keeperhub.com/plugins/ajna#pool-1-bucket-take)
...
| Input | Type | Description |
| --- | --- | --- |
| borrowerAddress\_ | address | Borrower Address |
| depositTake\_ | bool | Use Deposit Take |
| index\_ | uint256 | Bucket Index |
...
## Pool 1 Settle[](https://docs.keeperhub.com/plugins/ajna#pool-1-settle)
...
| --- | --- | --- |
| borrowerAddress\_ | address | Borrower Address |
| maxDepth\_ | uint256 | Max Bucket Depth |
...
## Pool 1 Withdraw Bonds[](https://docs.keeperhub.com/plugins/ajna#pool-1-withdraw-bonds)
...
| Input | Type | Description |
| --- | --- | --- |
| recipient\_ | address | Recipient Address |
| maxAmount\_ | uint256 | Max Amount (WAD) |
...
## Pool 1 Update Interest[](https://docs.keeperhub.com/plugins/ajna#pool-1-update-interest)
...
## Pool 2 Kicker Info[](https://docs.keeperhub.com/plugins/ajna#pool-2-kicker-info)
...
## Pool 2 Auction Info[](https://docs.keeperhub.com/plugins/ajna#pool-2-auction-info)
...
## Pool 2 Bucket Info[](https://docs.keeperhub.com/plugins/ajna#pool-2-bucket-info)
...
## Pool 2 Inflator Info[](https://docs.keeperhub.com/plugins/ajna#pool-2-inflator-info)
...
## Pool 2 Kick[](https://docs.keeperhub.com/plugins/ajna#pool-2-kick)
...
## Pool 2 Bucket Take[](https://docs.keeperhub.com/plugins/ajna#pool-2-bucket-take)
...
## Pool 2 Settle[](https://docs.keeperhub.com/plugins/ajna#pool-2-settle)
...
## Pool 2 Withdraw Bonds[](https://docs.keeperhub.com/plugins/ajna#pool-2-withdraw-bonds)
...
## Pool 2 Update Interest[](https://docs.keeperhub.com/plugins/ajna#pool-2-update-interest)
...
## Vault 1 Is Paused[](https://docs.keeperhub.com/plugins/ajna#vault-1-is-paused)
...
## Vault 1 Get Buckets[](https://docs.keeperhub.com/plugins/ajna#vault-1-get-buckets)
...
## Vault 1 Total Assets[](https://docs.keeperhub.com/plugins/ajna#vault-1-total-assets)
...
## Vault 1 LP to Value[](https://docs.keeperhub.com/plugins/ajna#vault-1-lp-to-value)
...
## Vault 1 Drain Bucket[](https://docs.keeperhub.com/plugins/ajna#vault-1-drain-bucket)
...
## Vault 1 Move Liquidity[](https://docs.keeperhub.com/plugins/ajna#vault-1-move-liquidity)
...
| Input | Type | Description |
| --- | --- | --- |
| fromIndex\_ | uint256 | Source Bucket Index |
| toIndex\_ | uint256 | Destination Bucket Index |
| amt\_ | uint256 | Amount (WAD) |
...
## Vault 1 Move From Buffer[](https://docs.keeperhub.com/plugins/ajna#vault-1-move-from-buffer)
...
## Vault 1 Move To Buffer[](https://docs.keeperhub.com/plugins/ajna#vault-1-move-to-buffer)
...
## Vault 2 Is Paused[](https://docs.keeperhub.com/plugins/ajna#vault-2-is-paused)
...
## Vault 2 Get Buckets[](https://docs.keeperhub.com/plugins/ajna#vault-2-get-buckets)
...
## Vault 2 Total Assets[](https://docs.keeperhub.com/plugins/ajna#vault-2-total-assets)
...
## Vault 2 LP to Value[](https://docs.keeperhub.com/plugins/ajna#vault-2-lp-to-value)
...
## Vault 2 Drain Bucket[](https://docs.keeperhub.com/plugins/ajna#vault-2-drain-bucket)
...
## Vault 2 Move Liquidity[](https://docs.keeperhub.com/plugins/ajna#vault-2-move-liquidity)
...
## Vault 2 Move From Buffer[](https://docs.keeperhub.com/plugins/ajna#vault-2-move-from-buffer)
...
## Vault 2 Move To Buffer[](https://docs.keeperhub.com/plugins/ajna#vault-2-move-to-buffer)
...
## Vault 1 Buffer Ratio[](https://docs.keeperhub.com/plugins/ajna#vault-1-buffer-ratio)
...
## Vault 1 Min Bucket Index[](https://docs.keeperhub.com/plugins/ajna#vault-1-min-bucket-index)
...
## Vault 2 Buffer Ratio[](https://docs.keeperhub.com/plugins/ajna#vault-2-buffer-ratio)
...
## Vault 2 Min Bucket Index[](https://docs.keeperhub.com/plugins/ajna#vault-2-min-bucket-index)
...
## Vault 1 Buffer Total[](https://docs.keeperhub.com/plugins/ajna#vault-1-buffer-total)
...
## Vault 2 Buffer Total[](https://docs.keeperhub.com/plugins/ajna#vault-2-buffer-total)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/ajna#example-workflows)

### Automated Liquidation Keeper (Pool 1)[](https://docs.keeperhub.com/plugins/ajna#automated-liquidation-keeper-pool-1)
...
### Liquidation Settle and Bond Withdrawal[](https://docs.keeperhub.com/plugins/ajna#liquidation-settle-and-bond-withdrawal)
...
### Vault Buffer Rebalancing (Vault 1)[](https://docs.keeperhub.com/plugins/ajna#vault-buffer-rebalancing-vault-1)
...
### Vault Pause Guard[](https://docs.keeperhub.com/plugins/ajna#vault-pause-guard)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/ajna#supported-chains)
