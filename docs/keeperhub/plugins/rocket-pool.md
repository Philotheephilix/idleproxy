<!-- source: https://docs.keeperhub.com/plugins/rocket-pool -->
...
## Actions[](https://docs.keeperhub.com/plugins/rocket-pool#actions)
...
## Get rETH Exchange Rate[](https://docs.keeperhub.com/plugins/rocket-pool#get-reth-exchange-rate)
...
## Get rETH Balance[](https://docs.keeperhub.com/plugins/rocket-pool#get-reth-balance)
...
## Get rETH Total Supply[](https://docs.keeperhub.com/plugins/rocket-pool#get-reth-total-supply)
...
## Get Total ETH Collateral[](https://docs.keeperhub.com/plugins/rocket-pool#get-total-eth-collateral)
...
## Deposit ETH for rETH[](https://docs.keeperhub.com/plugins/rocket-pool#deposit-eth-for-reth)
...
## Burn rETH for ETH[](https://docs.keeperhub.com/plugins/rocket-pool#burn-reth-for-eth)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/rocket-pool#example-workflows)

### rETH Exchange Rate Monitor[](https://docs.keeperhub.com/plugins/rocket-pool#reth-exchange-rate-monitor)
...
### rETH Balance Tracker with Alert[](https://docs.keeperhub.com/plugins/rocket-pool#reth-balance-tracker-with-alert)
...
### Staking Yield Calculator[](https://docs.keeperhub.com/plugins/rocket-pool#staking-yield-calculator)
...
### Protocol TVL Monitor[](https://docs.keeperhub.com/plugins/rocket-pool#protocol-tvl-monitor)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/rocket-pool#supported-chains)
