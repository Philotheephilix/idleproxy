<!-- source: https://docs.keeperhub.com/plugins/chainlink -->
...
## Actions[](https://docs.keeperhub.com/plugins/chainlink#actions)
...
## Get Latest Round Data[](https://docs.keeperhub.com/plugins/chainlink#get-latest-round-data)
...
## Get Round Data[](https://docs.keeperhub.com/plugins/chainlink#get-round-data)
...
## Get Latest Answer[](https://docs.keeperhub.com/plugins/chainlink#get-latest-answer)
...
## Get Decimals[](https://docs.keeperhub.com/plugins/chainlink#get-decimals)
...
## Get Description[](https://docs.keeperhub.com/plugins/chainlink#get-description)
...
## Get Version[](https://docs.keeperhub.com/plugins/chainlink#get-version)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/chainlink#example-workflows)

### Price Feed Monitor with Discord Alerts[](https://docs.keeperhub.com/plugins/chainlink#price-feed-monitor-with-discord-alerts)
...
### Stale Feed Detection[](https://docs.keeperhub.com/plugins/chainlink#stale-feed-detection)
...
### Multi-Feed Price Dashboard[](https://docs.keeperhub.com/plugins/chainlink#multi-feed-price-dashboard)
...
### Price Threshold Alert[](https://docs.keeperhub.com/plugins/chainlink#price-threshold-alert)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/chainlink#supported-chains)
