<!-- source: https://docs.keeperhub.com/plugins/yearn-v3 -->
...
## Actions[](https://docs.keeperhub.com/plugins/yearn-v3#actions)
...
## Vault Deposit[](https://docs.keeperhub.com/plugins/yearn-v3#vault-deposit)
...
## Vault Withdraw[](https://docs.keeperhub.com/plugins/yearn-v3#vault-withdraw)
...
## Vault Redeem[](https://docs.keeperhub.com/plugins/yearn-v3#vault-redeem)
...
## Price Per Share[](https://docs.keeperhub.com/plugins/yearn-v3#price-per-share)
...
## Total Idle Assets[](https://docs.keeperhub.com/plugins/yearn-v3#total-idle-assets)
...
## Total Debt[](https://docs.keeperhub.com/plugins/yearn-v3#total-debt)
...
## Is Vault Shutdown[](https://docs.keeperhub.com/plugins/yearn-v3#is-vault-shutdown)
...
## API Version[](https://docs.keeperhub.com/plugins/yearn-v3#api-version)
...
## Profit Max Unlock Time[](https://docs.keeperhub.com/plugins/yearn-v3#profit-max-unlock-time)
...
## Full Profit Unlock Date[](https://docs.keeperhub.com/plugins/yearn-v3#full-profit-unlock-date)
...
## Vault Accountant[](https://docs.keeperhub.com/plugins/yearn-v3#vault-accountant)
...
## Deposit Limit[](https://docs.keeperhub.com/plugins/yearn-v3#deposit-limit)
...
## Example Workflows[](https://docs.keeperhub.com/plugins/yearn-v3#example-workflows)

### Monitor Vault Performance[](https://docs.keeperhub.com/plugins/yearn-v3#monitor-vault-performance)
...
### Auto-Deposit on Capacity[](https://docs.keeperhub.com/plugins/yearn-v3#auto-deposit-on-capacity)
...
### Emergency Shutdown Monitor[](https://docs.keeperhub.com/plugins/yearn-v3#emergency-shutdown-monitor)
...
### Vault Utilization Report[](https://docs.keeperhub.com/plugins/yearn-v3#vault-utilization-report)
...
## Supported Chains[](https://docs.keeperhub.com/plugins/yearn-v3#supported-chains)
...
## Technical Notes[](https://docs.keeperhub.com/plugins/yearn-v3#technical-notes)
