<!-- source: https://docs.keeperhub.com/practices/security -->

# Security Best Practices

# Security Best Practices

## Wallet Security[](https://docs.keeperhub.com/practices/security#wallet-security)
...
## Keeper Configuration[](https://docs.keeperhub.com/practices/security#keeper-configuration)
...
## Multisig Monitoring[](https://docs.keeperhub.com/practices/security#multisig-monitoring)
...
## Access Management[](https://docs.keeperhub.com/practices/security#access-management)
...
## Notification Security[](https://docs.keeperhub.com/practices/security#notification-security)
...
## Operational Security[](https://docs.keeperhub.com/practices/security#operational-security)
