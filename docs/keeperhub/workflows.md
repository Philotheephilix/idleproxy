<!-- source: https://docs.keeperhub.com/workflows -->
...
## What are Workflows?[](https://docs.keeperhub.com/workflows#what-are-workflows)
...
## The Visual Workflow Builder[](https://docs.keeperhub.com/workflows#the-visual-workflow-builder)
...
## Node Types[](https://docs.keeperhub.com/workflows#node-types)

### Trigger Nodes[](https://docs.keeperhub.com/workflows#trigger-nodes)
...
### Action Nodes[](https://docs.keeperhub.com/workflows#action-nodes)
...
### Condition Nodes[](https://docs.keeperhub.com/workflows#condition-nodes)

A condition node evaluates a value from an earlier node against a target using a comparison operator (equals, greater than, less than, and so on) and branches the workflow based on the result. See [Creating Workflows](https://docs.keeperhub.com/workflows/creating) for the available operators.

## Building Your First Workflow[](https://docs.keeperhub.com/workflows#building-your-first-workflow)
...
## AI-Assisted Workflow Creation[](https://docs.keeperhub.com/workflows#ai-assisted-workflow-creation)
...
## Hub[](https://docs.keeperhub.com/workflows#hub)

Browse the [Hub](https://docs.keeperhub.com/workflows/hub) to discover workflow templates shared by the community and import them into your workspace.
