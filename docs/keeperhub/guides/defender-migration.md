<!-- source: https://docs.keeperhub.com/guides/defender-migration -->
...
## What’s Changing[](https://docs.keeperhub.com/guides/defender-migration#whats-changing)
...
## Comparison[](https://docs.keeperhub.com/guides/defender-migration#comparison)
...
## Feature Mapping[](https://docs.keeperhub.com/guides/defender-migration#feature-mapping)

### Defender Monitor —> Workflow Monitoring[](https://docs.keeperhub.com/guides/defender-migration#defender-monitor----workflow-monitoring)
...
### Defender Relayer —> Transaction Execution[](https://docs.keeperhub.com/guides/defender-migration#defender-relayer----transaction-execution)
...
### Defender Actions —> Workflow Automation[](https://docs.keeperhub.com/guides/defender-migration#defender-actions----workflow-automation)

Defender Actions ran custom serverless scripts. In KeeperHub, these become visual workflows — built through the canvas or generated with the AI assistant. The [Workflow Hub](https://docs.keeperhub.com/workflows/hub) has templates for common patterns like balance monitoring, contract execution, and multi-step alerting.

### Additional Capabilities[](https://docs.keeperhub.com/guides/defender-migration#additional-capabilities)
...
## Migration Steps[](https://docs.keeperhub.com/guides/defender-migration#migration-steps)

### 1\. Audit Your Defender Setup[](https://docs.keeperhub.com/guides/defender-migration#1-audit-your-defender-setup)
...
### 2\. Set Up KeeperHub[](https://docs.keeperhub.com/guides/defender-migration#2-set-up-keeperhub)

Create your account, configure chain connections, and set up your wallet for transaction signing.

### 3\. Recreate Your Workflows[](https://docs.keeperhub.com/guides/defender-migration#3-recreate-your-workflows)

Use the workflow builder or AI assistant to recreate your automations. Check the [Workflow Hub](https://docs.keeperhub.com/workflows/hub) for templates that match your existing patterns.

### 4\. Run in Parallel[](https://docs.keeperhub.com/guides/defender-migration#4-run-in-parallel)
